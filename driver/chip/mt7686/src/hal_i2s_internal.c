...
//FOR DVT USE
//#define log_hal_info printf
//#define log_hal_error printf
...
hal_i2s_status_t i2s_set_clock(i2s_internal_t *hal_i2s, hal_i2s_sample_rate_t sample_rate)
{
    ...
    i2s0_global_cg = (uint32_t)(0x20028);
    i2s0_dl_cg = (uint32_t)(0x8);
    i2s0_ul_cg = (uint32_t)(0x8);
    i2s1_global_cg = (uint32_t)(0x20028);
    i2s1_dl_cg = (uint32_t)(0x8);
    i2s1_ul_cg = (uint32_t)(0x8);

    switch (sample_rate) {
        case HAL_I2S_SAMPLE_RATE_8K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_8K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_8K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_8K;
            sampling_rate = (uint8_t)0x0;
            fs_base = HAL_I2S_FS_BASE_8KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_11_025K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_11_025K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_11_025K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_11_025K;
            sampling_rate = (uint8_t)0x1;
            fs_base = HAL_I2S_FS_BASE_11_025KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_12K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_12K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_12K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_12K;
            sampling_rate = (uint8_t)0x2;
            fs_base = HAL_I2S_FS_BASE_8KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_16K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_16K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_16K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_16K;
            sampling_rate = (uint8_t)0x4;
            fs_base = HAL_I2S_FS_BASE_8KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_22_05K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_22_05K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_22_05K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_22_05K;
            sampling_rate = (uint8_t)0x5;
            fs_base = HAL_I2S_FS_BASE_11_025KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_24K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_24K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_24K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_24K;
            sampling_rate = (uint8_t)0x6;
            fs_base = HAL_I2S_FS_BASE_8KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_32K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_32K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_32K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_32K;
            sampling_rate = (uint8_t)0x8;
            fs_base = HAL_I2S_FS_BASE_8KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_44_1K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_44_1K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_44_1K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_44_1K;
            sampling_rate = (uint8_t)0x9;
            fs_base = HAL_I2S_FS_BASE_11_025KHZ;
            break;
        ...
        case HAL_I2S_SAMPLE_RATE_48K:
            ...
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_48K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_48K;
            sampling_rate = (uint8_t)0xa;
            fs_base = HAL_I2S_FS_BASE_8KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_88_2K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_88_2K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_88_2K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_88_2K;
            sampling_rate = (uint8_t)0xb;
            fs_base = HAL_I2S_FS_BASE_11_025KHZ;
            break;

        case HAL_I2S_SAMPLE_RATE_96K:
            log_hal_info("HAL_I2S_SAMPLE_RATE_96K\r\n");
            hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_96K;
            hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_96K;
            sampling_rate = (uint8_t)0xc;
            fs_base = HAL_I2S_FS_BASE_8KHZ;
            break;
        ...
        case HAL_I2S_SAMPLE_RATE_176_4K:
            ...
            if (hal_i2s->i2s_user_config.frame_sync_width == HAL_I2S_FRAME_SYNC_WIDTH_128) {
                ...
                hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_176_4K;
                hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_176_4K;
                sampling_rate = (uint8_t)0xd;
                fs_base = HAL_I2S_FS_BASE_11_025KHZ;
            }
            break;
        ...
        case HAL_I2S_SAMPLE_RATE_192K:
            ...
            if (hal_i2s->i2s_user_config.frame_sync_width == HAL_I2S_FRAME_SYNC_WIDTH_128) {
                ...
                hal_i2s->i2s_user_config.i2s_in.sample_rate = HAL_I2S_SAMPLE_RATE_192K;
                hal_i2s->i2s_user_config.i2s_out.sample_rate = HAL_I2S_SAMPLE_RATE_192K;
                sampling_rate = (uint8_t)0xe;
                fs_base = HAL_I2S_FS_BASE_8KHZ;
            }
            break;
    ...
    //set sampling rate
    if (hal_i2s->i2s_port == HAL_I2S_0) {
        DRV_Reg8(I2S_DL_SR_EN_CONTROL__F_CR_I2S_OUT_SR) = sampling_rate;
        DRV_Reg8(I2S_UL_SR_EN_CONTROL__F_CR_I2S_IN_SR) = sampling_rate;
        ...
        DRV_Reg8(I2S1_DL_SR_EN_CONTROL__F_CR_I2S1_OUT_SR) = sampling_rate;
        DRV_Reg8(I2S1_UL_SR_EN_CONTROL__F_CR_I2S1_IN_SR) = sampling_rate;
    ...
    //log_hal_info("hal_i2s->i2s_user_config.i2s_in.sample_rate=%d\r\n", hal_i2s->i2s_user_config.i2s_in.sample_rate);
    //log_hal_info("hal_i2s->i2s_user_config.i2s_out.sample_rate=%d\r\n", hal_i2s->i2s_user_config.i2s_in.sample_rate);

    i2s1_global_cg |= DRV_Reg32(I2S_GLOBAL_CONTROL);
    i2s1_dl_cg |= DRV_Reg32(I2S1_DL_CONTROL);
    i2s1_ul_cg |= DRV_Reg32(I2S1_UL_CONTROL);
    /*
    log_hal_info("First value\r\n");
    log_hal_info("I2S_GLOBAL_CONTROL=%x\r\n", (unsigned int)DRV_Reg32(I2S_GLOBAL_CONTROL));
    log_hal_info("I2S_DL_CONTROL=%x\r\n", (unsigned int)DRV_Reg32(I2S_DL_CONTROL));
    log_hal_info("I2S_UL_CONTROL=%x\r\n", (unsigned int)DRV_Reg32(I2S_UL_CONTROL));
    log_hal_info("I2S1_GLOBAL_CONTROL=%x\r\n", (unsigned int)DRV_Reg32(I2S1_GLOBAL_CONTROL));
    ...
    */
    ...
    if (hal_i2s->i2s_port == HAL_I2S_0) {
        ...
        if ((hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_26M) || (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_24_576M)) {
            i2s1_global_cg |= (uint32_t)0x40028;
        }
        if (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XPLL_22_5792M) {
