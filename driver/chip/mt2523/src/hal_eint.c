...
hal_eint_status_t hal_eint_set_debounce_count(hal_eint_number_t eint_number, uint32_t debounce_count)
{
    ...
    if ((debounce_count & (~EINT_CON_DBC_CNT_MASK))) {
        return HAL_EINT_STATUS_INVALID_PARAMETER;
    }
