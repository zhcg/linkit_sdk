...
static unsigned char pmu_power_mode_init_setting_E2[10][8] = {
    ...
    {	PMIC_VR_CTL_ENABLE	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_LP	, PMIC_LDO_PMOD_LP	, PMIC_SLP_WKUP_HW_CTL	, 0	, 0	},	//VA18
    {	PMIC_VR_CTL_ENABLE	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_LP	, PMIC_LDO_PMOD_LP	, PMIC_SLP_WKUP_SW_CTL	, 0	, 0	},	//VUSB
    {	PMIC_VR_CTL_ENABLE	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_LP	, PMIC_LDO_PMOD_LP	, PMIC_SLP_WKUP_SW_CTL	, 1	, 1	},	//VBT
    {	PMIC_VR_CTL_ENABLE	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_LP	, PMIC_LDO_PMOD_LP	, PMIC_SLP_WKUP_SW_CTL	, 0	, 0	},	//VA28
    {	PMIC_VR_CTL_ENABLE	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_NORMAL	, PMIC_LDO_PMOD_LP	, PMIC_LDO_PMOD_LP	, PMIC_SLP_WKUP_SW_CTL	, 0	, 0	}	//VMC
};
...
void pmu_init_power_mode(unsigned char power_mode_setting[10][8])
{
    ...
    PMIC_VR_CONTROL(PMIC_SWXM   , PMIC_VR_CTL_ENABLE);
