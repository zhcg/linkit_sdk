 ...
 */
static bt_gap_le_local_config_req_ind_t *ble_ancs_get_local_config(void)
{
 ...
 */
static bt_gap_le_bonding_info_t *ble_ancs_get_bonding_info(const bt_addr_t remote_addr)
{
    return &bonding_info;
}
 ...
 */
static bt_status_t ble_ancs_get_pairing_config(bt_gap_le_bonding_start_ind_t *ind)
{
...
void ble_ancs_end(void)
{
    ...
    bt_callback_manager_deregister_callback(bt_callback_type_gap_le_get_local_cofig, (void *)ble_ancs_get_local_config);
    bt_callback_manager_deregister_callback(bt_callback_type_gap_le_get_pairing_config, (void *)ble_ancs_get_pairing_config);
    bt_callback_manager_deregister_callback(bt_callback_type_gap_le_get_bonding_info, (void *)ble_ancs_get_bonding_info);
