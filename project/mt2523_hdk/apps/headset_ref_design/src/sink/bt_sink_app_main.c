...
void bt_sink_app_task_main(void *arg)
{
    ...
    bt_sink_app_context.feature_config.features = BT_SINK_SRV_FEATURE_POWER_ON_RECONNECT | BT_SINK_SRV_FEATURE_VISIBILITY | BT_SINK_SRV_FEATURE_IOS_HFP_CUSTOM_AT_COMMAND;
#else
