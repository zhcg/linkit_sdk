...
static uint32_t ulRealSystickClockHZ;
#ifndef configSYSTICK_CLOCK_HZ
#define configSYSTICK_CLOCK_HZ ulRealSystickClockHZ
#endif
...
{
    static long unsigned int ulReloadValue, ulCompleteTickPeriods;
