...
#define   EVENT_ID_IOT_ASSOC_TIMEOUT  0xFF
#define   EVENT_ID_IOT_RSNA_TIMEOUT   0xF1
#define   EVENT_ID_IOT_BSSID_NOT_MATCH 0xF2
#define   EVENT_ID_IOT_CIPPHER         0xF3
#define   EVENT_ID_IOT_SCAN_DRPOPPED   0xF4
#endif
